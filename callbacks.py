...
class ModelTest(Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        print("Standard accuracy/error at epoch %05d: %0.5f" % (epoch, float(np.mean(standard_accuracy))))
        print("MC accuracy/error at epoch %05d: %0.5f" % (epoch, float(np.mean(MC_accuracy))))
